...
live_in_set_previous = {0:[], 1:[], 2:[], 3:[], 4:[], 5:[]}
live_out_set_previous = {0:[], 1:[], 2:[], 3:[], 4:[], 5:[]}
...
successor_set = take_input(number_of_blocks, True)
use_dict = take_input(number_of_blocks, False)
definition_dict = take_input(number_of_blocks, False)
while(1):
    for i in order_list:
        temp_liveout = []
