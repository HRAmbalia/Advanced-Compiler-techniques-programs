...
# SUBJECT : ACT
# ROLL NO. : MT001
# AIM : Perform Live variable analysis

# Input : number of blocks, Successor set, Use dictionary set, USe definition set
# Output : Live-in and Live-out statements
...
def main():
    ...
    order_list = list(range(number_of_blocks-1, -1, -1))
